...
def draw_bounding_box_on_image_array(image,
    ...
    draw_bounding_box_on_image(image_pil, ymin, xmin, ymax, xmax, color,
                               thickness, display_str_list, fontsize,
...
def visualize_boxes_and_labels_on_image_array(
    ...
    Args:
      ...
      track_ids: a numpy array of shape [N] with unique track ids. If provided,
        ...
        indices.
      box_ids: a numpy array of box_ids [N]. If provided will be added to the label
    ...
    # the native format for this code is yx. If the network outputs in xy,
    # switch the order.
    if coords_order == 'xy' and len(boxes)>0:
        boxes = boxes[:, [1,0,3,2]]
