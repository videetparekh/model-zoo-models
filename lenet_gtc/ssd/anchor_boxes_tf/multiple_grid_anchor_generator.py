...
from ssd.anchor_boxes_tf import anchor_generator, grid_anchor_generator
from ssd.post_processing_tf import box_list_ops
...
def create_ssd_anchors(num_layers=6,
                       ...
                       aspect_ratios=(1.0, 2.0, 0.5, 3.0, 1.0/3), #(1.0, 2.0, 3.0, 1.0 / 2, 1.0 / 3),
